...
final List<Question> engLevelD1Questions = [
  Question(
    text: 'A student struggles to identify the main idea of a passage (e.g., choosing a minor detail). What would you do?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A provides direct support for main idea identification. B focuses on modeling, C adjusts the approach, D emphasizes explanation—all relevant to main idea support.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'A student hesitates when comparing and contrasting ideas from two passages (e.g., missing similarities). What’s your next step?',
    options: [
    ...
    correctAnswer: 'A & C',
    explanation: 'A and C offer guided comparison and explanation. B focuses on modeling, D uses examples—all relevant to comparison and contrast support.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'A student makes errors summarizing a passage (e.g., omitting key points). How should you respond?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with direct guidance. B focuses on modeling, C emphasizes details, D shifts to explanation—all relevant to summarizing support.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'A student finishes a vocabulary in context exercise quickly but with errors (e.g., wrong word choice). What would you do?',
    options: [
      'A. Review their work and guide them to correct answers.',
      'B. Let them retry the exercise with closer guidance.',
  ...
  Question(
    text: 'A student avoids participating in a group summarizing activity. What’s your best action?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A encourages participation. B focuses on modeling, C adjusts to private summarizing, D involves a peer—all relevant to group engagement.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'A student struggles with identifying details in a passage (e.g., missing supporting points). What should you do?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with guidance. B focuses on modeling, C emphasizes explanation, D uses examples—all relevant to detail identification support.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'A student hesitates to use vocabulary in context during practice (e.g., misapplying a word). What would you do?',
    options: [
      'A. Guide them to use the word correctly with support.',
    ...
    correctAnswer: 'A',
    explanation: 'A offers direct support. B shifts to modeling, C adjusts with explanation, D focuses on examples—all relevant to vocabulary in context support.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A connects to thinking skills. B focuses on differences, C emphasizes analysis, D is broader—all relevant to comparing’s purpose.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A emphasizes understanding. B focuses on details, C highlights writing, D looks ahead—all relevant to summarizing’s role.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A provides direct support in sessions. B involves home practice, C focuses on clues, D emphasizes passage use—all relevant to vocabulary support.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A links to retention skills. B focuses on structure, C emphasizes confidence, D looks ahead—all relevant to comprehension review.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'Parent Says: “My child makes mistakes when tired.”',
  ...
  Question(
    text: 'A student identifies the main idea incorrectly (e.g., selecting a detail). What’s the best first step?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with an explanation. B focuses on examples, C emphasizes modeling, D involves guidance—all relevant to main idea correction.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'A student hesitates comparing two passages. What’s your priority?',
  ...
  Question(
    text: 'A student skips details while summarizing a passage. What should you do first?',
    options: [
      'A. Review the passage with them, pointing to key details.',
      'B. Let them retry and check for missed details.',
    ...
    correctAnswer: 'A',
    explanation: 'A ensures immediate correction. B delays help, C offers hints, D focuses on modeling—all relevant to summary accuracy.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'A student struggles with using vocabulary in context. What’s your best action?',
    options: [
  ...
  Question(
    text: 'Case Study: A 14-year-old student struggles with identifying the main idea and stops. What’s the best way to help them progress?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A builds on their skill with support. B is more hands-on, C adjusts structure, D focuses on modeling—all relevant to main idea support.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'Case Study: A student compares 1-5 ideas correctly but struggles with 6-10. How should you support their learning?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A offers direct support. B focuses on errors, C shifts to modeling, D provides hints—all relevant to comparison progress.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'Case Study: A student makes frequent errors in summarizing passages. What’s your first step to correct this?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with real-time guidance. B focuses on examples, C emphasizes modeling, D involves retrying—all relevant to summarizing correction.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'Case Study: A student hesitates during a group vocabulary activity, looking at peers. What should you do to build confidence?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A boosts confidence with support. B focuses on modeling, C adjusts to private practice, D involves a peer—all relevant to group participation.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A focuses on fluency. B emphasizes accuracy, C highlights confidence, D targets summarizing—all relevant to main idea goals.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A enhances understanding. B focuses on accuracy, C emphasizes confidence, D ties to application—all relevant to comparison guidance.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A targets fluency. B focuses on accuracy, C emphasizes confidence, D highlights vocabulary—all relevant to the structure’s purpose.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'How should instructors handle a student skipping details in a summary?',
    options: [
      'A. Review the passage with them, pointing to key details.',
      'B. Let them retry with guidance on each detail.',
    ...
    correctAnswer: 'D',
    explanation: 'D applies; immediate correction is needed. A, B, and C are all relevant approaches to summary detail correction.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
  ...
  Question(
    text: 'According to Level D1, how should instructors introduce comparing passages?',
    options: [
      'A. Start with simple comparisons, then add complexity with guidance.',
      'B. Compare two passages with them, guiding each step.',
  ...
  Question(
    text: 'What does the manual suggest for students struggling with summarizing?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A aligns with guidance. B focuses on reviewing, C offers hints, D shifts to modeling—all relevant to summarizing support.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
    text: 'How should instructors use the 10-question structure?',
  ...
  Question(
    text: 'What is the aim of the vocabulary in context exercise per the manual?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A reflects the goal. B focuses on accuracy, C emphasizes confidence, D ties to integration—all relevant to vocabulary exercises.',
    level: QuestionLevel.EngLevelD1,
  ),
  Question(
...
final List<Question> engLevelD2Questions = [
  Question(
    text: 'A student struggles to summarize a passage (e.g., omitting key points). What would you do?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A provides direct support for summarizing. B focuses on modeling, C adjusts the approach, D emphasizes explanation—all relevant to summarizing support.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student hesitates when drawing conclusions from a passage (e.g., missing logical inferences). What’s your next step?',
    options: [
    ...
    correctAnswer: 'A & C',
    explanation: 'A and C offer guided inference and explanation. B focuses on modeling, D uses examples—all relevant to conclusion-drawing support.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student makes errors using vocabulary in context (e.g., incorrect word usage). How should you respond?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with direct guidance. B focuses on modeling, C emphasizes context, D shifts to explanation—all relevant to vocabulary support.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student finishes a cause and effect exercise quickly but with errors (e.g., wrong relationships). What would you do?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A addresses errors directly. B focuses on retrying, C emphasizes explanation, D shifts to a new exercise—all relevant to cause and effect correction.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student avoids participating in a group conclusion-drawing activity. What’s your best action?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A encourages participation. B focuses on modeling, C adjusts to private concluding, D involves a peer—all relevant to group engagement.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student struggles with identifying cause and effect in a passage (e.g., confusing causes with effects). What should you do?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with guidance. B focuses on modeling, C emphasizes explanation, D uses examples—all relevant to cause and effect support.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student hesitates to summarize a passage during practice (e.g., unsure of key points). What would you do?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A offers direct support. B shifts to modeling, C adjusts the approach, D focuses on explanation—all relevant to summarizing support.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student stops at question 5 in a 10-question comprehension set. What’s your approach?',
  ...
  Question(
    text: 'Parent Says: “My child summarizes the same passages daily. Is this necessary?”',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A ties repetition to summarizing. B focuses on conclusions, C emphasizes confidence, D targets mastery—all relevant to summarizing practice.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A connects to thinking skills. B focuses on implications, C emphasizes comprehension, D is broader—all relevant to conclusion-drawing’s purpose.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A emphasizes analysis. B focuses on relationships, C highlights reasoning, D looks ahead—all relevant to cause and effect’s role.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'Parent Says: “My child struggles with vocabulary in context.”',
  ...
  Question(
    text: 'A student summarizes a passage incorrectly (e.g., missing the main point). What’s the best first step?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with an explanation. B focuses on examples, C emphasizes modeling, D involves guidance—all relevant to summary correction.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student hesitates drawing conclusions from a passage. What’s your priority?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A combines support and practice. B adjusts the approach, C shifts to modeling, D focuses on explanation—all relevant to conclusion support.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student skips cause and effect relationships while analyzing a passage. What should you do first?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A ensures immediate correction. B delays help, C offers hints, D focuses on modeling—all relevant to cause and effect accuracy.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'A student struggles with using vocabulary in context. What’s your best action?',
  ...
  Question(
    text: 'Case Study: A 15-year-old student struggles with summarizing a passage and stops. What’s the best way to help them progress?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A builds on their skill with support. B is more hands-on, C adjusts structure, D focuses on modeling—all relevant to summarizing support.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'Case Study: A student draws 1-5 conclusions correctly but struggles with 6-10. How should you support their learning?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A offers direct support. B focuses on errors, C shifts to modeling, D provides hints—all relevant to conclusion progress.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'Case Study: A student makes frequent errors in identifying cause and effect. What’s your first step to correct this?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with real-time guidance. B focuses on examples, C emphasizes modeling, D involves retrying—all relevant to cause and effect correction.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'Case Study: A student hesitates during a group vocabulary activity, looking at peers. What should you do to build confidence?',
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A focuses on fluency. B emphasizes accuracy, C highlights confidence, D targets conclusions—all relevant to summarizing goals.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'Why does Kumon emphasize guidance during conclusion-drawing exercises?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A enhances understanding. B focuses on accuracy, C emphasizes confidence, D ties to application—all relevant to conclusion guidance.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'When should a student move from summarizing to identifying cause and effect?',
    options: [
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A targets fluency. B focuses on accuracy, C emphasizes confidence, D highlights summarizing—all relevant to the structure’s purpose.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'How should instructors handle a student skipping cause and effect in a passage?',
    options: [
      'A. Review the passage with them, pointing to relationships.',
    ...
    correctAnswer: 'D',
    explanation: 'D applies; immediate correction is needed. A, B, and C are all relevant approaches to cause and effect correction.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A builds fluency. B focuses on accuracy, C emphasizes confidence, D targets cause and effect—all relevant to repetition’s role.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'According to Level D2, how should instructors introduce drawing conclusions?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A follows the manual’s progression. B is hands-on, C adjusts structure, D focuses on modeling—all relevant to introducing conclusions.',
    level: QuestionLevel.EngLevelD2,
  ),
  Question(
    text: 'What does the manual suggest for students struggling with summarizing?',
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A ensures mastery. B focuses on independence, C ties to guidance, D emphasizes relationships—all relevant to comprehension progress.',
    level: QuestionLevel.EngLevelD2,
  ),
];
...
final List<Question> engLevelE1Questions = [
  Question(
    text: 'A student struggles to identify the main idea of a passage (e.g., selecting a minor detail). What would you do?',
    options: [
      'A. Guide them to find the main idea with support.',
      'B. Model identifying the main idea and ask them to repeat.',
      'C. Break the passage into parts and help them identify it.',
  ...
  Question(
    text: 'A student hesitates when making inferences from a passage (e.g., missing implied meaning). What’s your next step?',
    options: [
    ...
    correctAnswer: 'A & C',
    explanation: 'A and C offer guided inference and explanation. B focuses on modeling, D uses examples—all relevant to inference-making support.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'A student makes errors using vocabulary in context (e.g., wrong word choice). How should you respond?',
    options: [
      'A. Review the passage with them and guide the correct usage.',
      'B. Model using the word in context and ask them to follow.',
      'C. Point out the context and help them apply the word.',
  ...
  Question(
    text: 'A student finishes a figurative language exercise quickly but with errors (e.g., misinterpreting a metaphor). What would you do?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A addresses errors directly. B focuses on retrying, C emphasizes explanation, D shifts to a new exercise—all relevant to figurative language correction.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'A student avoids participating in a group inference activity. What’s your best action?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A encourages participation. B focuses on modeling, C adjusts to private inferring, D involves a peer—all relevant to group engagement.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'A student struggles with identifying details in a passage (e.g., missing supporting points). What should you do?',
  ...
  Question(
    text: 'A student hesitates to understand figurative language in a passage (e.g., confused by a simile). What would you do?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A offers direct support. B shifts to modeling, C adjusts with explanation, D focuses on examples—all relevant to figurative language support.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'A student stops at question 5 in a 10-question comprehension set. What’s your approach?',
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A ties repetition to comprehension. B focuses on inferences, C emphasizes confidence, D targets mastery—all relevant to passage practice.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A connects to expressive language. B focuses on imagery, C emphasizes depth, D is broader—all relevant to figurative language’s purpose.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A emphasizes understanding. B focuses on points, C highlights analysis, D looks ahead—all relevant to detail identification’s role.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'Parent Says: “My child struggles with vocabulary in context.”',
  ...
  Question(
    text: 'A student hesitates making inferences from a passage. What’s your priority?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A combines support and practice. B adjusts the approach, C shifts to modeling, D focuses on explanation—all relevant to inference support.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'A student skips details while analyzing a passage. What should you do first?',
    options: [
      'A. Review the passage with them, pointing to key details.',
      'B. Let them retry and check for missed details.',
      'C. Provide hints while they redo the analysis.',
    ...
    correctAnswer: 'A',
    explanation: 'A ensures immediate correction. B delays help, C offers hints, D focuses on modeling—all relevant to detail accuracy.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'A student struggles with understanding figurative language. What’s your best action?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A offers direct guidance. B focuses on modeling, C emphasizes explanation, D shifts to practice—all relevant to figurative language support.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'A student loses focus during a 10-question comprehension set. What’s your priority?',
  ...
  Question(
    text: 'Case Study: A 16-year-old student struggles with identifying the main idea and stops. What’s the best way to help them progress?',
    options: [
      'A. Guide them to identify with support.',
      'B. Identify the main idea with them, guiding each step.',
      'C. Break the passage into parts with guidance.',
  ...
  Question(
    text: 'Case Study: A student makes 1-5 inferences correctly but struggles with 6-10. How should you support their learning?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A offers direct support. B focuses on errors, C shifts to modeling, D provides hints—all relevant to inference progress.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'Case Study: A student makes frequent errors in understanding figurative language. What’s your first step to correct this?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A corrects with real-time guidance. B focuses on examples, C emphasizes modeling, D involves retrying—all relevant to figurative language correction.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'Case Study: A student hesitates during a group vocabulary activity, looking at peers. What should you do to build confidence?',
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A focuses on fluency. B emphasizes accuracy, C highlights confidence, D targets inferences—all relevant to main idea goals.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A enhances understanding. B focuses on accuracy, C emphasizes confidence, D ties to application—all relevant to inference guidance.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'When should a student move from identifying details to making inferences?',
    options: [
      'A. After consistent accuracy with detail identification.',
      'B. When they can identify details with minimal help.',
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A targets fluency. B focuses on accuracy, C emphasizes confidence, D highlights details—all relevant to the structure’s purpose.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'How should instructors handle a student skipping details in a passage?',
    options: [
      'A. Review the passage with them, pointing to key details.',
      'B. Let them retry with guidance on each detail.',
      'C. Provide examples of details to practice.',
    ...
    correctAnswer: 'D',
    explanation: 'D applies; immediate correction is needed. A, B, and C are all relevant approaches to detail correction.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A builds fluency. B focuses on accuracy, C emphasizes confidence, D targets figurative language—all relevant to repetition’s role.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'According to Level E1, how should instructors introduce making inferences?',
    options: [
      'A. Start with simple inferences, then add complexity with guidance.',
    ...
    correctAnswer: 'A',
    explanation: 'A follows the manual’s progression. B is hands-on, C adjusts structure, D focuses on modeling—all relevant to introducing inferences.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'What does the manual suggest for students struggling with figurative language?',
    options: [
    ...
    correctAnswer: 'A',
    explanation: 'A aligns with guidance. B focuses on reviewing, C offers hints, D shifts to modeling—all relevant to figurative language support.',
    level: QuestionLevel.EngLevelE1,
  ),
  Question(
    text: 'How should instructors use the 10-question structure?',
  ...
  Question(
    ...
    correctAnswer: 'A',
    explanation: 'A ensures mastery. B focuses on independence, C ties to guidance, D emphasizes figurative language—all relevant to comprehension progress.',
    level: QuestionLevel.EngLevelE1,
  ),
];
